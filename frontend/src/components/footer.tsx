                        ...
                        <div className="grid grid-cols-3 gap-12 sm:gap-12 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://github.com/Rust-Cameroon" className="hover:underline ">Github</a>
                                    </li>
                                    <li>
                                        <a href="https://discord.gg/Y5qqazcR7c" className="hover:underline">Discord</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="https://foundation.rust-lang.org/policies/privacy-policy/" className="hover:underline">Privacy Policy</a>
                                    </li>
                                    <li>
                                        <a href="https://www.rust-lang.org/policies/code-of-conduct" className="hover:underline">Terms &amp; Conditions</a>
                                    </li>
                                </ul>
                            </div>
                            <div className="grid grid-cols-2 lg:grid-cols-3">
                                <a href="https://discord.gg/Y5qqazcR7c" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                                ...
                                <a href="https://x.com/rustcameroon237/" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
                                ...
                                <a href="https://github.com/Rust-Cameroon" className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
