        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('home.features.learn.title')}</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('home.features.connect.title')}</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">{t('home.features.build.title')}</h3>
              <p className="text-gray-600 dark:text-gray-400">
