      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6">
              Whether you're a seasoned Rustacean or just starting your journey with Rust, 
              you're welcome in our community. We believe in learning together, sharing knowledge, 
              and supporting each other in our Rust journey.
            </p>
